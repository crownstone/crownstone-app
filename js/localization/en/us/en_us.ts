export default {
  ...
  SettingsMeshDebug:{
    ...
    Any:                                 function() { return arguments[0] ? arguments[1] : "Any" },
    You_have_to_be_in_a_spher:           function() { return "You have to be in a sphere in order to debug Mesh" },
    ...
    Set_to_Channel___:                   function() { return "Set to Channel 39" },
    Done:                                function() { return "Done" },
    Setting_Mesh_Channels_n_n:           function() { return "Setting Mesh Channels\n\n(" + arguments[0] + " out of " + arguments[1] + ")" },
    Floating___:                         function() { return "Floating..." },
