export default {
  ...
  DeviceOverview:{
    ...
    _Encountered_Cloud_Issue__left:         function() { return "OK" },
    _Encountered_a_problem____header:       function() { return "Encountered a problem." },
    _Encountered_a_problem____body:         function() { return "Failed trying to factory reset this Crownstone. Make sure you're close by and try again. If this continue to fail, you can choose delete it from your sphere without factory-resetting it" },
    _Encountered_a_problem____left:         function() { return "Force remove." },
    _Encountered_a_problem____right:        function() { return "I'll try again!" },
    _Encountered_Cloud_Issue___header:      function() { return "Encountered Cloud Issue." },
    _Encountered_Cloud_Issue___body:        function() { return "We cannot delete this Crownstone in the cloud. Please try again later" },
  ...
  SphereHubOverview:{
    ...
    _Ask_your_Sphere_Admin__A_header:       function() { return "Ask your Sphere Admin" },
    _Ask_your_Sphere_Admin__A_body:         function() { return "Admins can add new Hubs to Spheres. If you have a new Hubs you'd like to add, ask the sphere Admin." },
    _Ask_your_Sphere_Admin__A_left:         function() { return "OK" },
