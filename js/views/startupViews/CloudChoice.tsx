  ...
  render() {
    return (
      <Background background={require('../../images/mainBackground.png')}>
        ...
        <Text style={[setupStyle.h3, styles.centered, {flex:1,textAlign:'center'}]}>{ Languages.text("CloudChoice", "PLEASE_SELECT")() }</Text>
        <TouchableOpacity style={{paddingLeft:30, paddingRight:30}}>
          <View style={styles.rowCentered}>
            ...
            <View style={[{flexDirection:'column', flex:1}, styles.centered]}>
              <Text style={setupStyle.text}>{ Languages.text("CloudChoice", "Use_the_Cloud_to_store_da")() }</Text>
            </View>
          </View>
          <Text style={choiceStyle.smallText}>{ Languages.text("CloudChoice", "The_cloud_is_used_to_allo")() }</Text>
        </TouchableOpacity>
        <View style={{flex:1}} />
        <TouchableOpacity style={{paddingLeft:30, paddingRight:30}}>
          <View style={styles.rowCentered}>
            ...
            <View style={[{flexDirection:'column', flex:1}, styles.centered]}>
              <Text style={setupStyle.text}>{ Languages.text("CloudChoice", "Only_store_data_on_your_p")() }</Text>
            </View>
          </View>
          <Text style={choiceStyle.smallText}>{ Languages.text("CloudChoice", "If_you_are_the_only_user_")() }</Text>
        </TouchableOpacity>
        <View style={{flex:1}} />
      </Background>
    )
