...
export class GraphAxis extends Component<any, any> {
  ...
  render() {
    ...
    elements.push(<Text key={'UNIT'} x={options.padding} y={11} originX={0} fontSize={11} fontWeight="bold" fill={colors.white.hex} textAnchor="end" >{ Languages.text("GraphAxis", "_W_")() }</Text>);
