      ...
      <Background image={this.props.backgrounds.menu}>
        ...
        <ScrollView >
          <View style={{flex:1, alignItems:'center', justifyContent:'center'}}>
            ...
            <Text style={titleStyle}>{ Languages.text("SettingsBleTroubleshootingAndroid", "Troubleshooting")() }</Text>
            <View style={{height:20}} />
            <IconButton name="ios-bluetooth" buttonSize={80} size={60} button={true} color="#fff" buttonStyle={{backgroundColor:colors.blue.hex}} />
            <View style={{height:20}} />
            <Text style={headerStyle}>{ Languages.text("SettingsBleTroubleshootingAndroid", "Sometimes__the_Bluetooth_")() }</Text>
            <Text style={explanationStyle}>{ Languages.text("SettingsBleTroubleshootingAndroid", "Unfortunately__sometimes_")() }</Text>
            <Text style={explanationStyle}>{ Languages.text("SettingsBleTroubleshootingAndroid", "Im_sure_youre_all_familia")() }</Text>
            ...
            <Text style={explanationStyle}>{ Languages.text("SettingsBleTroubleshootingAndroid", "There_is_a_Bluetooth_icon")() }</Text>
            ...
            <Text style={explanationStyle}>{ Languages.text("SettingsBleTroubleshootingAndroid", "To_reset_Bluetooth_the_ri")() }</Text>
            ...
            <Text style={explanationStyle}>{ Languages.text("SettingsBleTroubleshootingAndroid", "In_the_settings_overview_")() }</Text>
            ...
            <Text style={explanationStyle}>{ Languages.text("SettingsBleTroubleshootingAndroid", "Finally__in_the_Bluetooth")() }</Text>
            ...
            <Text style={explanationStyle}>{ Languages.text("SettingsBleTroubleshootingAndroid", "The_result_should_be_")() }</Text>
            ...
            <Text style={explanationStyle}>{ Languages.text("SettingsBleTroubleshootingAndroid", "You_wait_for_a_few_second")() }</Text>
            <View style={{height:50}} />
            <Text style={headerStyle}>{ Languages.text("SettingsBleTroubleshootingAndroid", "Enjoy_using_your_Crownsto")() }</Text>
