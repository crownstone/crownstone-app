export default {
  ...
  ProblemWithLocalization:{
    ...
    You_can_find_the_Activity:           function() { return "Je kunt de Activity Log vinden bij de Crownstone eigenschappen: klikYou can find the Activity Log in the stone properties: tap on the room, tap on the Crownstone icon and navigate to the right until you see it." },
