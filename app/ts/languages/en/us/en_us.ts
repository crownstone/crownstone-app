export default {
  ...
  DeviceEditAppearance:{
    ...
    _Whoops___I_could_not_get_body:         function() { return "I could not get the all versions...." },
  ...
  DeviceLabels:{
    ...
    Problem_detected__tap_near:             function() { return "Problem... Tap here if you're near me." },
  ...
  DeviceOverview:{
    ...
    Appearance:                             function() { return "Appearance" },
  ...
  DevicePowerUsage:{
    ...
    Stand_near_the_Crownstone:              function() { return "Stand near the Crownstone to see the measurements flowing in! It will only measure if the app is on the screen."},
  ...
  HubProblems:{
    ...
    The_hub_reference_in_the_:              function() { return "The hub identifier in the app is missing. Press the button below to fix this!" },
    ...
    There_are_multiple_hubs_b:              function() { return "There are multiple hubs bound to this identifier... Press the button below to fix this!" },
  ...
  LocalizationAdvancedSettings:{
    ...
    Last_2__seconds:                        function() { return "Last 2 seconds" },
    Last_5___seconds:                       function() { return "Last 5 seconds" },
    Last_10___seconds:                      function() { return "Last 10 seconds" },
    Smoothing_method:                       function() { return "Smoothing method" },
    If_the_localization_is_er:              function() { return "If the localization is erratic, first try to improve the training data via the 'Improve from localization mistake' or 'Find and fix difficult spots'.\n\nIf that is not enough, you can use smoothing. Increased smoothing will take longer to respond to changes in your position." },
  ...
  LocalizationDetail:{
    ...
    Manage_fingerprints:                    function() { return "Manage datasets" },
    DEV__Delete_individual_fi:              function() { return "Delete individual datasets" },
  ...
  LocationPermissionOverlay:{
    ...
    Location_disabled:                      function() { return "Location disabled" },
    ...
    ManualPermission_body:                  function() { return "Without location services, Crownstones cannot respond to your location and the app can\'t communicate with Crownstones correctly.\n\nYou will have to manually allow location permission. Go to your phone's settings -> apps -> Crownstone -> Permissions -> Enable (always)." },
  ...
  Login:{
    ...
    Applying_preferences:                   function() { return "Applying preferences..." },
  ...
  ProblemWithExistingCrownstone:{
    ...
    I_can_hear_the_Crown_mesh:              function() { return "I can hear the Crownstone via the mesh, it should not be 'Searching...' anymore." },
    I_can_hear_the_directly:                function() { return "I can hear the Crownstone directly, it should not be 'Searching...' anymore." },
  ...
  SettingsFAQ:{
    ...
    Frequently_Asked_Question:              function() { return "How do I ..." },
  ...
  SettingsFactoryResetStep2:{
    ...
    Looking_for_Crownstones_n:              function() { return "Looking for Crownstones nearby..." },
    Attempting_to_reset_Crown:              function() { return "Attempting to reset Crownstone..." },
    Looking_for_Crownstones_ne:             function() { return "Looking for Crownstones nearby..." },
    _in_:                                   function() { return  arguments[0] + " in " + arguments[1] },
  },
  SettingsOverview:{
  ...
  SetupHub:{
    ...
    Something_went_wrong__:                 function() { return "Something went wrong.." },
    Please_verify_that_you_ar:              function() { return "Please verify that you are connected to the internet and try again." },
    Please_restart_the_Blueto:              function() { return "Please restart the Bluetooth on your phone and make sure you're really close to this hub!" },
    Please_try_again_later_:                function() { return "Please try again later!" },
    Aborted_:                               function() { return "Aborted." },
    The_Crownstone_was_not_ad:              function() { return "The Hub was not added to your Sphere." },
    Default_name_it_is_:                    function() { return "Default name it is!" },
    Thats_a_good_name_:                     function() { return "That's a good name!" },
    Lets_pick_an_icon_:                     function() { return "Let's pick an icon!" },
    Lets_give_this_Crownstone:              function() { return "Let's give this hub an icon so we can quickly recognize it!" },
    You_can_always_change_thi:              function() { return "You can always change this later in the hub's settings." },
    Cool__so_thatll_be_my_ico:              function() { return "Cool, so that'll be my icon!" },
    Lets_pick_a_room_:                      function() { return "Let's pick a room!" },
    In_which_room_did_you_put:              function() { return "In which room did you put " + arguments[0] + "?" },
    Working_on_it_:                         function() { return "Working on it!" },
    ...
    I_know_this_one_:                       function() { return "I know this one!" },
    This_Crownstone_was_alrea:              function() { return "This hub was already in your Sphere. I've restored it to the way it was!\n\n" + "Name: " + arguments[0] + "\n" + "Room: " + (arguments[1] || "Unknown") + "\n\n" + "What would you like to do now?" },
  ...
  StoneUtil:{
    ...
    _Encountered_a_problem____left:         function() { return "Force remove." },
