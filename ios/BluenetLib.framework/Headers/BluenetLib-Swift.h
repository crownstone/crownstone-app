...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="BluenetLib",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@interface BleManager : NSObject <CBPeripheralDelegate>
...
SWIFT_CLASS("_TtC10BluenetLib17BluenetCBDelegate")
@interface BluenetCBDelegate : NSObject <CBCentralManagerDelegate>
...
SWIFT_CLASS("_TtC10BluenetLib27BluenetCBDelegateBackground")
@interface BluenetCBDelegateBackground : BluenetCBDelegate
