...
RCT_EXTERN_METHOD(keepAliveState:(Boolean *)changeState state:(nonnull NSNumber *)state timeout:(nonnull NSNumber *)timeout callback:(RCTResponseSenderBlock)callback)
