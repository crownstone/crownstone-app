      ...
      <View style={{flex:1}}>
        ...
        <View style={{flexDirection:'column', flex:1, padding:20, alignItems:'center'}}>
          <Text style={{
            ...
            textAlign:'center'
          }}>{ Languages.text("RoomTraining_finished", "Finished_learning_about_t")() }</Text>
          <Text style={{
            backgroundColor:'transparent',
            fontSize:16,
            fontWeight:'300',
            ...
            textAlign:'center',
            paddingTop:20,
          }}>{ Languages.text("RoomTraining_finished", "Once_you_have_taught__all")(this.props.ai.name,this.props.ai.he,this.props.ai.his) }</Text>
          <View style={{flex:1}} />
          <TouchableOpacity
            style={[
