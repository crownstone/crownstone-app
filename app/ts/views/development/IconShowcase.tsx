...
function lang(key,a?,b?,c?,d?,e?) {
  return Languages.get("IconShowcase", key)(a,b,c,d,e);
}
...
import {DebugIconShowcase} from "./DebugIconShowcase";
...
const MAX_NUMBER_SHOWN = 160;

export class IconShowcase extends LiveComponent<{callback(icon: string) : void, icon: string, backgrounds: any}, any> {
