export default {
  ...
  ActivityLogItem:{
    ...
    _because_everyone_left_dim_room:     function() { return arguments[0] + arguments[1] + " % because everyone left the " + arguments[2] + '.' },
  },
  ...
  BatteryImprovements:{
    ...
    The_Crownstone_app_will_n:           function() { return "The Crownstone app will now use less power in the background for the localization features! The more Crownstones you have, the more efficient it becomes!" },
  },
  BugsFixedAndroid:{
  ...
  DeviceBehaviourEdit:{
    ...
    __seconds:                           function() { return "2 seconds" },
    ___seconds:                          function() { return "30 seconds" },
    __minute:                            function() { return "1 minute" },
