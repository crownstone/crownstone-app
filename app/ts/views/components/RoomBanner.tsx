  ...
  render() {
    ...
    return (
      <View style={{width:screenWidth, height:ELEMENT_HEIGHT, backgroundColor: colors.white.hex, borderBottomWidth :1, borderColor: colors.menuBackground.rgba(0.2), overflow:"hidden"}}>
        <Image source={require("../../../assets/images/backgrounds/RoomBannerBackground.jpg")} style={{width: screenWidth, height: ELEMENT_HEIGHT, opacity: 0.7, position:'absolute', top:0, left:0}} resizeMode={"cover"} />
