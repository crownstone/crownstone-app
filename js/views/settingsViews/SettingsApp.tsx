...
export class SettingsApp extends Component<any, any> {
  ...
  _getItems() {
    ...
    items.push({
      ...
      type: 'switch',
      icon: <IconButton name="c1-locationPin1" size={18} button={true} color="#fff" buttonStyle={{backgroundColor:colors.blue.hex}} />,
      callback:(newValue) => {
        store.dispatch({
          type: 'UPDATE_APP_SETTINGS',
    ...
    items.push({label: "Indoor localization allows the Crownstones to react to: " +
    "\n  - Enter/Exit Sphere" +
    "\n  - Enter/Exit Room" +
