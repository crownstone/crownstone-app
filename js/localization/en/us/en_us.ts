export default {
  ...
  AddItemsToSphere:{
    ...
    Add_to_Sphere:                       () => { return "Add to Sphere" },
  },
  AiStart:{
  ...
  ApplianceAdd:{
    ...
    Add_Device_Type:                     () => { return "Add Device Type" },
  },
  ApplianceEntry:{
  ...
  ApplianceSelection:{
    ...
    Select_Device_Type:                  () => { return "Select Device Type" },
  },
  ...
  CameraRollView:{
    ...
    Choose_a_Picture:                    () => { return "Choose a Picture" },
  },
  CancelButton:{
  ...
  DeviceEdit:{
    ...
    Edit_Device:                         () => { return "Edit Device" },
  },
  DeviceEntry:{
  ...
  DeviceIconSelection:{
    ...
    Pick_an_Icon:                        () => { return "Pick an Icon" },
  },
  DeviceOverview:{
  ...
  DeviceScheduleEdit:{
    ...
    You_cant_have_any_more_sc:           () => { return "You can't have any more scheduled actions. Please remove or deactivate an existing one to add this one." },
  ...
  DfuOverlay:{
    ...
    putting_Crownstone_in_upd:           () => { return "putting Crownstone in update mode..." },
  ...
  Login:{
    ...
    Verification_Email_Sent:             () => { return "Verification Email Sent" },
    Reset_Email_Sent:                    () => { return "Reset Email Sent" },
  },
  LoginSplash:{
  ...
  MessageAdd:{
    ...
    New_Message:                         () => { return "New Message" },
    Recipients:                          () => { return "Recipients" },
    Leave_where_:                        () => { return "Leave where?" },
  },
  MessageEntry:{
  ...
  PictureCircle:{
    ...
    Profile_Picture:                     () => { return "Profile Picture" },
  },
  PictureView:{
    __filename: "../js/views/cameraViews/PictureView.tsx",
    Done:                                () => { return "Done" },
    Cancel:                              () => { return "Cancel" },
    Take_Picture:                        () => { return "Take Picture" },
  },
  ...
  RegisterConclusion:{
    ...
    OK:                                  () => { return "OK" },
    Almost_Done_:                        () => { return "Almost Done!" },
  },
  ReviewInitialTests:{
  ...
  RoomAdd:{
    ...
    Create_Room:                         () => { return "Create Room" },
  },
  RoomBanner:{
  ...
  RoomTraining:{
    ...
    All_Done_:                           () => { return "All Done!" },
    Teaching_:                           () => { return "Teaching " + arguments[0] },
  },
  ...
  SettingsFactoryResetStep1:{
    ...
    Factory_Reset:                       () => { return "Factory Reset" },
  },
  ...
  SettingsRedownloadFromCloud:{
    ...
    Reset_from_Cloud:                    () => { return "Reset from Cloud" },
  },
  ...
  SphereBehaviour:{
    ...
    Sphere_behaviour:                    () => { return "Sphere behaviour" },
  },
  ...
  SphereInvitedUser:{
    ...
    Invited_User:                        () => { return "Invited User" },
  },
  SphereOverview:{
    ...
    Sphere_Overview:                     () => { return "Sphere Overview" },
    Hello_there_:                        () => { return "Hello there!" },
  },
  SphereRoomArranger:{
    __filename: "../js/views/main/editSubviews/SphereRoomArranger.tsx",
    Save:                                () => { return "Save" },
    Solve_Positions:                     () => { return "Solve Positions" },
    Drag_it_around_:                     () => { return "Drag it around!" },
  },
  SphereRoomOverview:{
    ...
    Add_a_room:                          () => { return "Add a room" },
    Rooms_in_:                           () => { return "Rooms in " + arguments[0] },
  },
  SphereUser:{
    ...
    Remove_from_Sphere:                  () => { return "Remove from Sphere" },
    Sphere_User:                         () => { return "Sphere User" },
  },
  SphereUserInvite:{
  ...
  SphereUserOverview:{
    ...
    Users_in_:                           () => { return "Users in " + arguments[0] },
  },
  Splash:{
  ...
  TapToToggleCalibration:{
    ...
    Waiting_to_start_learning:           () => { return "Waiting to start learning..." },
    Finding_Tap_to_Toggle_dis:           () => { return "Finding Tap-to-Toggle distance..." },
    Learning_Tap_to_Toggle_di:           () => { return "Learning Tap-to-Toggle distance..." },
    Tap_to_toggle_means_you_c:           () => { return "Tap-to-toggle means you can switch the Crownstone just by holding your phone really close to it!" },
    This_will_only_take_a_min:           () => { return "This will only take a minute and will only have to be done once. Hold your phone really close to a Crownstone and press 'Next'." },
    Now_that_I_can_recognise_:           () => { return "Now that I can recognise it with your phone, let's try tap-to-toggle!" },
    ...
    Back:                                () => { return "Back" },
    Using_Tap_to_Toggle:                 () => { return "Using Tap-to-Toggle" },
    Setting_it_up:                       () => { return "Setting it up" },
    Lets_give_it_a_try_:                 () => { return "Let's give it a try!" },
    Training_Tap_to_Toggle:              () => { return "Training Tap-to-Toggle" },
  },
  TimezoneScheduler:{
