      ...
      <View style={{flex:1, paddingBottom:0, alignItems:'center', justifyContent:'center'}}>
        <ScrollView style={[WNStyles.outerScrollView,{width: this.props.width}]}>
          <View style={WNStyles.innerScrollView}>
            <Text style={WNStyles.text}>{ Languages.text("Switchcraft", "Introducing___")() }</Text>
            ...
            <Text style={WNStyles.detail}>{ Languages.text("Switchcraft", "Switchcraft_allows_you_to")() }</Text>
          </View>
        </ScrollView>
      </View>
    );
