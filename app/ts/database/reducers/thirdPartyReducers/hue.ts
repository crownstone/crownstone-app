...
//
// // hueReducer
// let hueBridgeReducer = (state = defaultBridgeSettings, action : DatabaseAction = {}) => {
//   switch (action.type) {
//     case 'INJECT_IDS':
//       let newState = {...state};
...
//
// // hue lights Reducer
// let hueLightReducer = (state = defaultLightSettings, action : DatabaseAction = {}) => {
//   switch (action.type) {
//     case 'INJECT_IDS':
//       let newState = {...state};
...
//
// // hue reducer
// function hueLightCollectionReducer(state = {}, action : DatabaseAction = {}) {
//   switch (action.type) {
