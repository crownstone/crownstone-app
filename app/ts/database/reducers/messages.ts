...
// messageReducer
const messageReducer = (state = defaultState, action : DatabaseAction = {}) => {
  let newState;
  switch (action.type) {
...
const messageReadReducer = (state = defaultMessageState, action : DatabaseAction = {}) => {
  switch (action.type) {
  ...
  switch (action.type) {
    ...
    default:
      if (action.messageStateId !== undefined) {
        if (state[action.messageStateId] !== undefined || action.type === "MARK_MESSAGE_AS_READ" ) {
          return {
            ...state,
...
// messageReducer
const messageDeletedReducerBase = (state = {}, action : DatabaseAction = {}) => {
  switch (action.type) {
    ...
    default:
      if (action.messageStateId !== undefined) {
        if (state[action.messageStateId] !== undefined || action.type === "MARK_MESSAGE_AS_DELETED" ) {
          return {
            ...state,
