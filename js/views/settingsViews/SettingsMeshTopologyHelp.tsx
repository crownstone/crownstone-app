...
export class SettingsMeshTopologyHelp extends Component<any, any> {
  static navigationOptions = ({ navigation }) => {
    return { title: Languages.title("SettingsMeshTopologyHelp", "Mesh_Help")()}
  };
      ...
      <Background hasNavBar={false} image={this.props.backgrounds.menu}>
        ...
        <ScrollView >
          <View style={{flex:1, alignItems:'center', justifyContent:'center'}}>
            ...
            <Text style={titleStyle}>{ Languages.text("SettingsMeshTopologyHelp", "Mesh_Topology")() }</Text>
            <View style={{height:20}} />
            <IconButton name="md-share" buttonSize={80} size={60} button={true} color="#fff" buttonStyle={{backgroundColor:colors.green.hex}} />
            <View style={{height:10}} />
            <Text style={explanationStyle}>{ Languages.text("SettingsMeshTopologyHelp", "Crownstones_can_talk_to_e")() }</Text>
            ...
            <Text style={explanationStyle}>{ Languages.text("SettingsMeshTopologyHelp", "Every_other_second_the_Cr")() }</Text>
            <View style={{width:screenWidth, height:120, alignItems:'center', justifyContent:'center'}}>
              <MeshElement __reachableOverride={true} key={"explanation2"} id={1} nodeData={mockData} pos={[0,0]} radius={50} />
            </View>
            <Text style={explanationStyle}>{ Languages.text("SettingsMeshTopologyHelp", "Every_second__the_backgro")() }</Text>
            ...
            <Text style={explanationStyle}>{ Languages.text("SettingsMeshTopologyHelp", "The_connectivity_among_Cr")() }</Text>

            <Text style={headerStyle}>{ Languages.text("SettingsMeshTopologyHelp", "Enjoy_the_Mesh_")() }</Text>
